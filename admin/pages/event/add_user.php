<?php
	...
	if(isset($_POST['code'])){
        ...
        $result=mysqli_query($conn, "select *  from registration where  code='$code'");
        ...
        {			
            ...
            $sql = "UPDATE currently_running SET date_ended = '$date' WHERE code = '$code'";
                            ...
                            <head>
                            <meta charset="UTF-8">
                            <title>PUNTA FUEGO  | RUNNER NOTIFICATION </title>
                                    ...
                                    <table role="presentation" class="main">
                                        ...
                                        <td class="wrapper">
                                            ...
                                            <tr>
                                                ...
                                                <p>YOU COMPLETED THE RACE TODAY AT  | '.strtoupper($date).'</p><br>
        ...
        
        {
            ...
            $sql = "INSERT INTO currently_running (code, category, date) VALUES ('$code', '$category', '$date')";
                            ...
                            <table role="presentation" class="main">
                                ...
                                <td class="wrapper">
                                    ...
                                    <tr>
                                        ...
                                        <br>
                                        <p>Hi! '.strtoupper($email).',</p>
                                        <p>YOU STARTED THE RACE TODAY AT  | '.strtoupper($date).'</p><br>
	...
	header('location: map.php?id='.$id.'&category='.$category);
?>