...
<div style="margin:10px;">
  <div style="margin-bottom:7px"> <input type="hidden" id="routeFrom" name="routeFrom" value="<?php echo  $start;  ?>" />
    </div>
   <div style="margin-bottom:12px"> <input type="hidden" id="routeTo" name="routeTo" value="<?php echo  $end;  ?>" />
   </div>
